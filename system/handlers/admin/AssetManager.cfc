component extends="preside.system.base.AdminHandler" {
	...
	function uploadAssetAction( event, rc, prc ) {
		...
		} else if( ArrayContainsNoCase( imageExtensions, fileExtension ) && ( !imageManipulationService.isValidImageFile( tempFileInfo.serverDirectory & "/" & tempFileInfo.serverFile ) ) ) {
			result.success = false;
